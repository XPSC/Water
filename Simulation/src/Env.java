...
public class Env {
	...
	static int p_sub_res = 5;  //ratio donnant la resolution de l'isocontour (surface du fluide), qui est plus précise.
	...
	// TO DO
	//
	// pr�ciser narrow band (phi, particules)
	// stabilit�, robustesse
	//
	//  am�lioration : interpolations -> for particles, for boundaries conditions ? for the p solver
	//
